#!/bin/bash
# Vanilla EAGLE3 baseline — static (num_steps=3, topk=1, ndt=4) small chain.
# Runs all five datasets so throughput is directly comparable to
# hpc/bench_dynamic.sh and hpc/bench_static_7_1_8.sh.
#
# Usage:  bash hpc/bench_static_3_1_4.sh {llama|deepseek|qwen}
set -euo pipefail
...
echo "============================================================"
echo "  Static EAGLE3 (3,1,4) — $MODEL_TAG"
echo "  Model: $MODEL"
echo "  Draft: $DRAFT"
...
echo ""
echo "============================================================"
echo "  STATIC (3,1,4) COMPLETE — $TAG"
