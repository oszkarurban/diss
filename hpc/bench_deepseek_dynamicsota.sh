...
#SBATCH --output=logs/bench_ds_dsota_%j.out
#SBATCH --error=logs/bench_ds_dsota_%j.err
...
TAG="deepseek_llamadraft_dynamicsota"
PORT=30000
...
echo "============================================================"
echo " V6.5 Dynamic SOTA — $MODEL (Llama draft)"
