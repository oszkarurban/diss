...
#SBATCH --output=logs/trace_llama_%j.out
#SBATCH --error=logs/trace_llama_%j.err

# Phase A trace collection: 6 configs × 3 benchmarks × 20 q = 18 runs on Llama.
# Signals: top1_prob, target_top1_prob, rolling_accept_rate per decode step.
# See /home/ou222/.claude/plans/lovely-bubbling-moore.md for full context.
...
# (config_label, extra launch flags)
#   static_3_1_4   : num_steps=3, topk=1, ndt=4
#   static_7_1_8   : num_steps=7, topk=1, ndt=8
#   static_7_4_8   : num_steps=7, topk=4, ndt=8
#   static_6_10_60 : num_steps=6, topk=10, ndt=60 (user-confirmed, NOT 10,6,60)
#   v3_dynamic     : V3 linear-interp, start=(3,1,4) max=(7,4,8)
#   v6_dynamic     : V6 3-zone,       start=(3,1,4) max=(10,5,16)
declare -a CONFIGS=(
...
for cfg in "${CONFIGS[@]}"; do
    ...
    # Throughput via existing bench_eagle3
    for bench in "${BENCHMARKS[@]}"; do
        ...
        # Signal-log extraction via collect_traces
