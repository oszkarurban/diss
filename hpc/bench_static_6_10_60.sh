#!/bin/bash
# Vanilla EAGLE3 baseline — static (num_steps=10, topk=6, ndt=60) wide-deep tree.
# Runs all five datasets so throughput is directly comparable to
# hpc/bench_dynamic.sh, hpc/bench_static_3_1_4.sh, and hpc/bench_static_7_1_8.sh.
#
# Usage:  bash hpc/bench_static_6_10_60.sh {llama|deepseek|qwen}
set -euo pipefail
...
echo "============================================================"
echo "  Static EAGLE3 (topk=6, num_steps=10, ndt=60) — $MODEL_TAG"
echo "  Model: $MODEL"
echo "  Draft: $DRAFT"
...
echo ""
echo "============================================================"
echo "  STATIC (6,10,60) COMPLETE — $TAG"
